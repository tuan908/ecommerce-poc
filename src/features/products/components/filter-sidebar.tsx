  ...
  return (
    <>
      ...
      <div className="lg:hidden mb-4">
        <Button onClick={onToggle} variant="outline" className="w-full justify-between">
                ...
                {[
                  ...
                  <div key={availability.value} className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => handleAvailabilityChange(availability.value, checked as boolean)}
                    />
                    <Label
